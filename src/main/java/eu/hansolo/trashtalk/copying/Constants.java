...
public class Constants {
    ...
    public static final int       NO_OF_COLS_SURVIVER          = 7;
    public static final int       NO_OF_ROWS_SURVIVER          = 12;
    public static final long      AGING_INTERVAL               = 1_000_000_000;  // Interval between calls to object aging (default 500_000_000)
    public static final long      AGING_AMOUNT                 = 2_000;        // Milliseconds that will be subtracted from object lifetime (default 1_000)
    ...
    public static final long      PAUSE_TIME                   = 1000;          // Time to pause between different actions (default 1_000)
