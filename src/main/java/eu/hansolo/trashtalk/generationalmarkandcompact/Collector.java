...
public class Collector {
    ...
    public Collector() throws StateChangeException {
        ...
        this.eden              = new ObservableMatrix<>(Obj.class, Constants.NO_OF_ROWS_EDEN,     Constants.NO_OF_COLS_EDEN);
        ...
        this.stateMachine.stateProperty().addOnChange(evt -> {
            ...
            switch (evt.getValue()) {
                ...
                case PROMOTING_ALL -> {
                    ...
                    availableSpaceInTenured = tenured.stream().filter(ref -> ref.get().isFree()).count();
