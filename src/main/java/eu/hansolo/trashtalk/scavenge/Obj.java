...
public class Obj {
    ...
    public boolean isReferenced() { return this.getState() == CellState.REFERENCED; }
    public boolean isDeReferenced() { return this.getState() == CellState.DEREFERENCED; }
    public boolean isFree() { return this.getState() == CellState.FREE; }
